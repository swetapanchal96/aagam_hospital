            ...
            <div class="row align-items-center">
                <div class="col-lg-6">
                    <div class="hero-content">
                        ...
                        <!-- <div class="job-search-area">
                                <form>
                                    <div class="form-inner job-title">
                                        <img src="{{ asset('assets/frontassets/images/icon/job3.svg')}}" alt>
                                        <input type="text" placeholder="What jobs are you looking for?">
                                    </div>
                                    <div class="form-inner">
                                        <button type="submit" class="primry-btn-2 "><img src="{{ asset('assets/frontassets/images/icon/search-icon.svg')}}" alt> Search</button>
                                    </div>
                                </form>
                            </div> -->
                        ...
                        <div class="user-area">
                            <ul>
                                <li><img src="{{ asset('assets/frontassets/images/bg/user31.png')}}" alt></li>
                                <li><img src="{{ asset('assets/frontassets/images/bg/user32.png')}}" alt></li>
                                <li><img src="{{ asset('assets/frontassets/images/bg/user33.png')}}" alt></li>
                                <li><img src="{{ asset('assets/frontassets/images/bg/user34.png')}}" alt></li>
                                <li><img src="{{ asset('assets/frontassets/images/bg/user35.png')}}" alt></li>
                                <li>
                ...
                <div class="col-lg-6">
                    <div class="hero-img">
                        <!-- <img class="img-fluid" src="{{ asset('assets/frontassets/images/bg/hero3-img-with-vec.jpg')}}" alt> -->
                    </div>
                </div>
            </div>
        </div>
...
<div class="home3-about-area mt-120 mb-120">
    <div class="container">
        <div class="row g-lg-4 gy-5 align-items-center">
            <div class="col-lg-5">
                <div class="about-left">
                    <div class="section-title1 mb-60">
                        <h2>About <span> Platinum HR
                                Solutions </span> </h2>
                        <p>Formally known as a Platinum HR is professionally managed company, specializing in all types
                            of recruitments and has successfully completed several hundreds of national recruitment
                            assignments with eminent business houses and
                            organizations.</p>
                    </div>
                    <div class="facility-area">
                        <ul>
                            <li>
                                <div class="icon">
                                    <img src="{{ asset('assets/frontassets/images/icon/facility-1.svg')}}" alt>
                                </div>
                                <div class="content">
                                    <h5>Highly Secured</h5>
                                    <!-- <p>Firstly, your account to be secured in login or sign up & don’t be upset, be confident. </p> -->
                                </div>
                            </li>
                            <li>
                                <div class="icon">
                                    <img src="{{ asset('assets/frontassets/images/icon/facility-2.svg')}}" alt>
                                </div>
                                <div class="content">
                                    <h5>Authentic Source</h5>
                                    <!-- <p>Secondly, Every job post to be secured in login or sign up & don’t be upset, be confident. </p> -->
                                </div>
                            </li>
                            <li>
                                <div class="icon">
                                    <img src="{{ asset('assets/frontassets/images/icon/facility-3.svg')}}" alt>
                                </div>
                                <div class="content">
                                    <h5>Cost Effective</h5>
                                    <!-- <p>Thirdly, Every job post to be secured in login or sign up & don’t be upset, be confident. </p> -->
                                </div>
                            </li>
                        </ul>
                    </div>
            ...
            <div class="col-lg-7">
                <div class="about-right">
                    <div class="about-img1">
                        <img class="img-fluid" src="{{ asset('assets/frontassets/images/bg/about-img-31.png')}}" alt>
                    </div>
                    <div class="about-img2">
                        <img class="img-fluid" src="{{ asset('assets/frontassets/images/bg/about-img-32.png')}}" alt>
                        <div class="ellipse">
                        </div>
                        <div class="best-quality-card">
                            <div class="quality-icon">
                                <img src="{{ asset('assets/frontassets/images/icon/best-quality-icon.svg')}}" alt>
                            </div>
                            <div class="content">
                                <h6><span>Best Quality</span> For Jobs Site</h6>
            ...
            <div class="row g-4">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="job-listing-card2">
                        <div class="job-thumb">
                            <!-- <img class="img-fluid" src="{{ asset('assets/frontassets/images/bg/job-list-1.png')}}" alt> -->
                            <div class="bookmark">
                        ...
                        <div class="job-content">
                            <div class="company-area">
                                <div class="logo">
                                    <!-- <img src="{{ asset('assets/frontassets/images/bg/company-logo/company-01.png')}}" alt> -->
                                </div>
                                <div class="company-details">
                                    <div class="name-location">
                                        <h5><a href="{{route('FrontapplyForJob',[$jvalue->jobId])}}">{{ $jvalue->jobTitle }}</a></h5>
                                        <ul>
                                            <li>
                                                <p><a href="#">{{$jvalue->functions}}</a></p>
                                            </li>
                                            <li>
                                ...
                                <ul>
                                    <li>
                                        <p><span class="title">Salary:</span> ₹ {{$jvalue->salary}} 
                                            <!-- / 
                                            <span
                                                class="time">Per Hour</span> -->
                                            </p>
                                    </li>
                                    <li>
                                        <p><span class="title">Experience:</span> 
                                                {{$jvalue->experience}} @if (is_int($jvalue->experience)) Years @endif
                                            </p>
                                    </li>
                                    <li>
                                        <p><span class="title">Location:</span> {{$jvalue->city}}, {{$jvalue->state}}</p>
                                    </li>
                                </ul>
                            </div>
                            <div class="job-type-apply">
                                ...
                                <div class="apply-btn">
                                    <a href="{{route('FrontapplyForJob',[$jvalue->jobId])}}"><span><img
                                                src="{{ asset('assets/frontassets/images/icon/apply-ellipse.svg')}}" alt></span>Apply
                                        Now</a>
                                </div>
                            </div>
                        </div>
        ...
        <div class="row">
            <div class="swiper category3-slider">
                <div class="swiper-wrapper">
                    @foreach($service as $svalue)
                    <div class="swiper-slide">
                        <div class="category-card3">
                            @if($svalue->photo == '')
                                <img src="{{ asset('assets/images/noImage.png')}}"  class="img-fluid">
                            @else
                                <img src="{{ asset('/Service/').'/'.$svalue->photo}}"  class="img-fluid" >
                            @endif

                            <div class="category-content">

                                <h5><a href="{{route('FrontService',[$svalue->serviceId])}}">{{ $svalue->serviceName }}</a></h5>
        ...
        <div class="row g-4 justify-content-center">
            ...
            <div class="col-lg-3 col-md-4 col-sm-6">
                <div class="single-work-area">
                    ...
                    <div class="content">
                        <h5><a href="{{route('FrontSearchJob')}}">Create Resume</a></h5>
                        <p>To create your account be confident & safely.</p>
                    </div>
                </div>
            </div>
...
<div class="home3-user-feedback mb-120">
    <div class="container">
        <div class="row g-4 gy-5">
                        ...
                        <div class="row divider justify-content-center">
                            <div class="col-sm-6 mb-60">
                                <div class="counter-single">
                                    <div class="counter-icon">
                                        <img src="{{ asset('assets/frontassets/images/icon/job2.svg')}}" alt="image">
                                    </div>
                                    <div class="coundown">
                                        <p>Live Jobs</p>
                                        <div class="d-flex align-items-center gap-2">
                                            <h3 class="odometer">20223</h3>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-6 mb-60">
                                <div class="counter-single two">
                                    <div class="counter-icon">
                                        <img src="{{ asset('assets/frontassets/images/icon/companies.svg')}}" alt="image">
                                    </div>
                                    <div class="coundown">
                                        <p>Companies</p>
                                        <div class="d-flex align-items-center gap-2">
                                            <h3 class="odometer">803</h3>
                                            <span>+</span>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-sm-6 d-flex">
                                <div class="counter-single three">
                                    <div class="counter-icon">
                                        <img src="{{ asset('assets/frontassets/images/icon/candidates.svg')}}" alt="image">
                                    </div>
                                    <div class="coundown">
                                        <p>Candidates</p>
                                        <div class="d-flex align-items-center gap-2">
                            ...
                            <div class="col-sm-6">
                                <div class="counter-single four">
                                    <div class="counter-icon">
                                        <img src="{{ asset('assets/frontassets/images/icon/new-jobs.svg')}}" alt="image">
                                    </div>
                                    <div class="coundown">
                                        <p>New Jobs</p>
                                        <div class="d-flex align-items-center gap-2">
                                            <h3 class="odometer">102</h3>
                                            <span>+</span>
                                        </div>
                                    </div>
                                </div>
            ...
            <div class="col-lg-6">
                <div class="swiper user-feedback-slider3">
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <div class="user-feedback-wrap">
                                <div class="user-feedback-top">
                                    <div class="author-area">
                                        <div class="author-img">
                                            <img src="{{ asset('assets/frontassets/images/bg/testimonial-author3.png')}}" alt>
                                        </div>
                        ...
                        <div class="swiper-slide">
                            <div class="user-feedback-wrap">
                                <div class="user-feedback-top">
                                    <div class="author-area">
                                        <div class="author-img">
                                            <img src="{{ asset('assets/frontassets/images/bg/testimonial-author2.png')}}" alt>
                                        </div>
                                        <div class="author-content">
                        ...
                        <div class="swiper-slide">
                            <div class="user-feedback-wrap">
                                <div class="user-feedback-top">
                                    <div class="author-area">
                                        <div class="author-img">
                                            <img src="{{ asset('assets/frontassets/images/bg/testimonial-author1.png')}}" alt>
                                        </div>
                                        <div class="author-content">
                    ...
                    <div class="swiper-btn-2">
                        <div class="swiper-prev prev-6">
                            <i class="bi bi-chevron-left"></i>
                        </div>
                        <div class="swiper-next next-6">
                            <i class="bi bi-chevron-right"></i>
                        </div>
                    </div>
                </div>
...
<div class="home1-trusted-company two mt-120 mb-120">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                    ...
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <div class="company-logo">
                                <img src="{{ asset('assets/frontassets/images/bg/company-logo/trusted-company-01.png')}}" alt>
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="company-logo">
                                <img src="{{ asset('assets/frontassets/images/bg/company-logo/trusted-company-02.png')}}" alt>
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="company-logo">
                                <img src="{{ asset('assets/frontassets/images/bg/company-logo/trusted-company-03.png')}}" alt>
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="company-logo">
                                <img src="{{ asset('assets/frontassets/images/bg/company-logo/trusted-company-04.png')}}" alt>
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="company-logo">
                                <img src="{{ asset('assets/frontassets/images/bg/company-logo/trusted-company-05.png')}}" alt>
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="company-logo">
                                <img src="{{ asset('assets/frontassets/images/bg/company-logo/trusted-company-06.png')}}" alt>
                            </div>
                        </div>
                    </div>
                </div>
