...
<div class="home3-about-area mt-120 mb-60">
    <div class="container">
        <div class="row g-lg-4 gy-5 align-items-center">
                ...
                <div class="about-left">
                    <div class="section-title1 mb-60">
                        ...
                        <p>Formally known as a Platinum HR is professionally managed company, specializing in all types
                            of
                            recruitments and has successfully completed several hundreds of national recruitment
                            assignments with eminent business houses and organizations.
                        </p>
                        <p>
                            PHRS was established by Mr. Akash Dave with a commitment to partner corporate in their
                            growth
                            by providing total recruitment solutions. Mr.Akash Dave Master of Business Administration by
                            profession with vast national as well as international experience in ﬁeld of HR.
                        </p>
            ...
            <div class="col-lg-12">
                <p>
                    PHRS started from a seed in recruitment and labor contract and is on its growing phase and
                    within a few years it will be a HR tree with various branches spread across India offering total HR
                    solutions.
                </p>
                <p>
                    Since our inspections, we have a focused and concentrated approach in partnering our client in
                    their growth and searching the best talent for them.
                </p>
...
<div class="home3-value-area  mb-60">
    <div class="container">
        <div class="row">
            <div class="col-lg-6 col-md-6 ">
                <div class="col-lg-12  value-box">
                    <h3>Our <span>Vision</span></h3>
                    <p>To provide highest quality support clients, in tune with its quality policy, objectives and
                        Values and Services for it.</p>
                    <p>
                        To establish our company amongst one of the largest players in all departments of our core
                        competency.</p>
                </div>
                <div class="col-lg-12   value-box">
                    <h3>Our <span>Value</span></h3>
                    <p>Our core values are integrity, care, innovation, passion and trust.</p>
                </div>
            </div>

            <div class="col-lg-6  col-md-6 value-box">
                <h3>Our <span>Mission</span></h3>
                <p>To work closely with our clients and help they succeed in setting and meeting their goals.</p>
                <p>
                    To provide innovative, professional and customized services to corporate through HR Solutions</p>
                <p>
                    To increase the numbers of outsourced associates.</p>
                <p>
                    To increase PHRS direct manpower strength.</p>
                <p>
                    To establish our new branch ofﬁces at Delhi, Jaipur, Indore, Mumbai.</p>
                <p>
                    To set up HR recruitment for Gulf Countries.</p>
            </div>
        </div>
    </div>
</div>
