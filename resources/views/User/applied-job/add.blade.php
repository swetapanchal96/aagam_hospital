                                ...
                                @csrf
                                    <div class="row gy-4">
                                        ...
                                        <div class="col-lg-6 col-md-6">
                                            ...
                                            <select class="form-control" name="state" {{ old('state') }} required>
                                        ...
                                        <div class="col-lg-6 col-md-6">
                                            ...
                                            <select class="form-control" name="city" {{ old('city') }} required>
                                        ...
                                        <div class="col-lg-12 col-md-6">
                                            ...
                                            <textarea  class="form-control" name="jobDescription" id="jobDescription" cols="4">{{ old('jobDescription') }}</textarea>
                                        </div>
