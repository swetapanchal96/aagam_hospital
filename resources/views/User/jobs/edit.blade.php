                                ...
                                @csrf
                                    <div class="row gy-4">
                                        ...
                                        <div class="col-lg-6 col-md-6">
                                            ...
                                            <select class="form-control" name="education" {{ old('education') }} required>
                                                ...
                                                @foreach($Education as $evalue)
                                                    <option value="{{$evalue->educationId}}" {{ $evalue->educationId == $job->educationId ? 'selected' : '' }}>{{$evalue->educationName}}</option>
                                                @endforeach
                                            </select>
                                        </div> 
                                        <div class="col-lg-6 col-md-6">
                                        ...
                                        <div class="col-lg-6 col-md-6">
                                            ...
                                            <select class="form-control" name="stateId" id="state" {{ old('state') }} required>
                                        ...
                                        <div class="col-lg-6 col-md-6">
                                            ...
                                            <select class="form-control" name="cityId" id="city" {{ old('city') }} required>
