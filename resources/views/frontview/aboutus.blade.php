...
<div class="page-content bg-white">
        ...
        <div class="banner-wraper">
          <div
            class="page-banner"
            style="background-image: url({{ asset('Front/assets/images/banner/img1.jpg)') }}">
            <div class="container">
            ...
            <!--  src="{{ asset('Front/assets/images/shap/wave-blue.png') }}"-->
            <!--  alt />-->
            <!--<img-->
            <!--  class="pt-img2 animate2"-->
            <!--  src="{{ asset('Front/assets/images/shap/circle-dots.png') }}"-->
            <!--  alt />-->
            <!--<img-->
            <!--  class="pt-img3 animate-rotate"-->
            <!--  src="{{ asset('Front/assets/images/shap/plus-blue.png') }}"-->
            <!--  alt />-->
          </div>
          <!-- Breadcrumb row END -->
        </div>
        ...
        <section class="section-sp1 about-area">
            ...
            <div class="row align-items-center">
                ...
                <div class="about-thumb-area">
                  <ul>
                    <li>
                      <img
                        class="about-thumb1"
                        src="{{ asset('Front/assets/images/about/pic-1.jpg') }}"
                        alt />
                    </li>
                    <li>
                      <img
                        class="about-thumb2"
                        src="{{ asset('Front/assets/images/about/pic-2.jpg') }}"
                        alt />
                    </li>
                    <li>
                      <img
                        class="about-thumb3"
                        src="{{ asset('Front/assets/images/about/pic-3.jpg') }}"
                        alt />
                    </li>
                    <li>
              ...
              <div class="col-lg-6 mb-30">
                <div class="heading-bx">
                  ...
                  <p>
                    Aagam Hospital is a leading healthcare facility
                    and the best hospital for knee pain treatment
                    in Satellite, offering advanced orthopedic care
                    with precision and compassion. Our expert doctors
                    specialize in diagnosing and treating joint issues,
                    making us a trusted back pain treatment hospital in
                    Satellite and a reliable choice for shoulder pain
                    treatment hospital in Satellite. As a reputed orthopedic
                    hospital in Satellite, we use modern technology, 
                    personalized treatment plans, and a patient-first
                    approach to ensure faster recovery and lasting results.
                    At Aagam Hospital, your mobility, comfort, and overall
                ...
                <!--  </div>-->
                <!--</div>-->
                <a href="{{ route('FrontContact') }}" class="btn btn-primary shadow">Contact
                  US</a>
              </div>
            </div>
          </div>
          ...
          <img
            class="pt-img2 animate2"
            src="images/shap/circle-small-blue.png"
            alt />
          <img
            class="pt-img3 animate-rotate"
            ...
            <div class="row">
              <div class="col-xl-3 col-sm-6 mb-30">
                <div class="feature-container feature-bx3">
                  ...
                  <h5 class="ttr-title">Emergency Help</h5>
                  <!--<p>-->
              ...
              <div class="col-xl-3 col-sm-6 mb-30">
                <div class="feature-container feature-bx3">
                  ...
                  <h5 class="ttr-title">Qualified Doctors</h5>
                  <!--<p>-->
                  <!--  Etiam ante ante, molestie vitae cursus ac, pharetra euismod-->
                  <!--  libero.-->
                  <!--</p>-->
              ...
              <div class="col-xl-3 col-sm-6 mb-30">
                <div class="feature-container feature-bx3">
                  ...
                  <h5 class="ttr-title">Best Professionals</h5>
                  <!--<p>-->
                  <!--  Etiam ante ante, molestie vitae cursus ac, pharetra euismod-->
                  <!--  libero.-->
                  <!--</p>-->
              ...
              <div class="col-xl-3 col-sm-6 mb-30">
                <div class="feature-container feature-bx3">
                  ...
                  <h5 class="ttr-title">Medical Treatment</h5>
                  <!--<p>-->
                  <!--  Etiam ante ante, molestie vitae cursus ac, pharetra euismod-->
                  <!--  libero.-->
                  <!--</p>-->
        ...
        <section class="section-sp1">
          <div class="container">
            <div class="heading-bx  text-center">
              <h6 class="title-ext text-secondary">Our Specialist</h6>
            </div>
            <div class="row">
              <div class="col-lg-4">
                <div class="img-wrapper">
                  <img src="{{ asset('Front/assets/images/main-banner/doctor.png') }}"
                    class="img-fluid img-style" alt>
                </div>
              </div>
              <div class="col-lg-8">
                <h2 class="title">
                ...
                <p>Dr Padmanabh Vora is an Ahmedabad-based Orthopaedic surgeon
                  with over 9 years of national and international experience in
                  Orthopaedic Surgery. His subspecialty interest is in field of
                  Joint preservation, Joint replacement and Complex limb trauma
                  wherein he has performed more than 1500 surgeries
                  independently.
                </p>
                <p>After finishing his post-graduation in Orthopaedics from
                  renowned B.J. Medical College, Ahmedabad in 2016, he went to
                  United Kingdom to pursue further specialty training. He worked
                  in Tameside General Hospital, Greater Manchester and Hampshire
                  Hospital, Basingstoke with world-renowned hip and knee surgeon
                  teams. He cleared MRCS exams to become Member of Royal College
                  of Surgeons, Edinburgh in 2020. He pursued research degree and
                  achieved M.Ch in Orthopaedics from Edgehill University,
                  Ormskirk in 2022</p>
              </div>
              <div class="col-lg-12 my-2">
                <p>Dr Vora has worked in public sector hospitals on important
                  positions well as private sector and corporate hospitals in
                  India. He has rich work experience in NHS England over 5
                  years. He actively engages with various academic associations
                  and societies to keep himself updated in Orthopaedics. Dr Vora
                  strongly believes in high ethical standards, integrity and
                  accountability. Over years, he has received great response and
                  feedback from his professional colleagues, seniors and most
                  importantly patients for his work.</p>
              </div>
            </div>
            ...
            <div class="row mt-5">
              ...
              <div class="col-lg-8 order-2 order-lg-1">
                ...
                <p>Dr. Maitry Shah is a dedicated and compassionate Paediatric
                Consultant with a strong commitment to providing high-quality
                care for children from birth through adolescence. She completed
                her medical and paediatric training from the prestigious B.J.
                Medical College, Ahmedabad in 2016 and further pursued advanced
                paediatric training in the United Kingdom.
                </p>
                <p>Dr. Shah gained valuable experience working in the NHS,
                England, particularly at the renowned Frimley Park Hospital,
                where she served as a Registrar in the Paediatrics Department
                for over 3 years. Her international exposure has equipped her
                with a broad, evidence-based approach to child healthcare
                , combining clinical excellence with a gentle, child-friendly manner.She specialises in managing a wide range of childhood conditions
                including newborn care, infections, allergies, developmental concerns
                , nutrition, and chronic paediatric illnesses. </p>
              </div>
              <div class="col-lg-4 order-1 order-lg-2">
                <div class="img-wrapper">
                  <img src="{{ asset('Front/assets/images/main-banner/doctor-2.png') }}"
                    class="img-fluid img-style" alt>
                </div>
              </div>
              <div class="col-lg-12 my-2 order-3">
                <p>Parents value her warm
                communication style, thorough assessments, and ability to make both
                children and caregivers feel at ease. Whether it’s a routine check-up,
                vaccination, or a more complex concern, Dr. Maitry Shah ensures every
                child receives personalised and thoughtful care in a safe, supportive environment.</p>
              </div>
            </div>
          </div>
        </section>
